...
$string['sourcefolder_desc'] = 'Nombre de la carpeta, dentro de la raíz del repositorio filesystem, donde están los contenidos originales de los cursos. Deje este campo vacío si las carpetas de los cursos están directamente en la raíz del repositorio (por ejemplo, <code>&lt;raíz_repo&gt;/50020125-IFC303-16805/01/index.html</code>). Escriba <code>recursos-editables</code> si la estructura es <code>&lt;raíz_repo&gt;/recursos-editables/50020125-IFC303-16805/01/index.html</code>. Las versiones editadas siempre se guardan en <code>&lt;raíz_repo&gt;/editions/&lt;shortname&gt;/&lt;resourceid&gt;/&lt;version&gt;/</code>.';
...
$string['editionsfolder_found'] = 'Curso {$a} ya procesado previamente. Se reconocerán las versiones existentes.';
$string['importededitions_start'] = 'Importando versiones editadas existentes para el curso {$a}...';
...
$string['editable_filearea_empty'] = 'El recurso editable {$a->cmname} (curso {$a->course}) no tiene contenido en Moodle, por lo que no se ha podido crear o reconstruir su versión original. Elimine el recurso y vuelva a procesar el curso.';
$string['version_folder_empty'] = 'La versión {$a->version} del recurso {$a->cmname} (curso {$a->course}) no contiene archivos, por lo que no se puede aplicar.';
...
$string['launchtask_desc'] = 'Permite ejecutar manualmente las tareas del plugin: la generación de materiales editables y la importación de versiones de materiales, para todos los cursos, para un curso concreto o para un centro completo. Ambas generan un documento de log en la carpeta editions/_logs/ del repositorio.';
$string['launchtask_task'] = 'Tarea a ejecutar';
$string['launchtask_task_generate'] = 'Generación de materiales editables';
$string['launchtask_task_generate_desc'] = 'Crea los recursos editables e imprimibles de los cursos a partir de sus contenidos dinámicos (SCORM/IMSCP).';
$string['launchtask_task_migrate'] = 'Importación de versiones de materiales';
$string['launchtask_task_migrate_desc'] = 'Copia las versiones editadas guardadas bajo identificadores antiguos hacia los recursos actuales de los cursos.';
$string['launchtask_migrate_requirement'] = 'Atención: la importación de versiones requiere que la generación de materiales editables se haya ejecutado correctamente con anterioridad sobre los cursos afectados, ya que empareja las versiones con los recursos existentes.';
$string['launchtask_migrationoptions'] = 'Opciones de la importación';
$string['launchtask_applyversion'] = 'Aplicar versión tras importar';
$string['launchtask_applyversion_desc'] = 'Opcional. Nombre de la versión a aplicar a los módulos una vez migrada (p. ej. v1_2025-2026). Vacío = no aplicar ninguna.';
...
$string['launchtask_migration_coursenotfound'] = 'Curso no encontrado en Moodle: {$a}';
$string['launchtask_migration_noeditions'] = 'No existe la carpeta editions/ para el curso: {$a}';
...
$string['launchtask_center_desc'] = 'Se procesarán todos los cursos no procesados cuyo código de centro (primer tramo del nombre corto) coincida con el indicado, p. ej. 50020125.';
$string['launchtask_centercode'] = 'Código de centro';
$string['launchtask_center_empty'] = 'Debe indicar un código de centro.';
$string['launchtask_center_none'] = 'No se han encontrado cursos sin procesar para el centro indicado.';
