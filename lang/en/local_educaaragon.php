...
$string['launchtask_center_notfound'] = 'There is no module with the given centre code: {$a}';
$string['launchtask_migration_centernone'] = 'No edition folders were found for the given centre: {$a}';
$string['logs'] = 'Execution logs';
$string['logs_desc'] = 'Log documents generated by the material generation and version import executions. They are stored in the logs/ folder at the materials repository root.';
$string['logs_empty'] = 'No execution logs have been generated yet.';
$string['logs_file'] = 'File';
$string['logs_modified'] = 'Date';
$string['logs_size'] = 'Size';
