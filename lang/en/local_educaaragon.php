...
$string['editionsfolder_found'] = 'Course {$a} already processed previously. Existing versions will be recognized.';
$string['importededitions_start'] = 'Importing existing edited versions for course {$a}...';
...
$string['editable_filearea_empty'] = 'The editable resource {$a->cmname} (course {$a->course}) has no content in Moodle, so its original version could not be created or rebuilt. Delete the resource and process the course again.';
$string['version_folder_empty'] = 'Version {$a->version} of the resource {$a->cmname} (course {$a->course}) contains no files, so it cannot be applied.';
...
$string['launchtask_desc'] = 'Allows you to manually run the plugin tasks: editable material generation and material version import, for all courses, for a specific course or for a whole centre. Both generate a log document in the editions/_logs/ folder of the repository.';
$string['launchtask_task'] = 'Task to run';
$string['launchtask_task_generate'] = 'Editable material generation';
$string['launchtask_task_generate_desc'] = 'Creates the editable and printable resources of the courses from their dynamic contents (SCORM/IMSCP).';
$string['launchtask_task_migrate'] = 'Material version import';
$string['launchtask_task_migrate_desc'] = 'Copies the edited versions stored under old identifiers to the current course resources.';
$string['launchtask_migrate_requirement'] = 'Note: the version import requires the editable material generation to have been run successfully beforehand on the affected courses, since it pairs the versions with the existing resources.';
$string['launchtask_migrationoptions'] = 'Import options';
$string['launchtask_applyversion'] = 'Apply version after import';
$string['launchtask_applyversion_desc'] = 'Optional. Name of the version to apply to the modules once migrated (e.g. v1_2025-2026). Empty = apply none.';
...
$string['launchtask_migration_coursenotfound'] = 'Course not found in Moodle: {$a}';
$string['launchtask_migration_noeditions'] = 'The editions/ folder does not exist for the course: {$a}';
...
$string['launchtask_center_desc'] = 'All unprocessed courses whose centre code (first token of the shortname) matches the given one will be processed, e.g. 50020125.';
$string['launchtask_centercode'] = 'Centre code';
$string['launchtask_center_empty'] = 'You must enter a centre code.';
$string['launchtask_center_none'] = 'No unprocessed courses were found for the given centre.';
...
$string['launchtask_reprocess'] = 'Reprocess course';
$string['launchtask_reprocess_confirm'] = 'The selected course has already been processed. To reprocess it, the previously generated resources will be removed. Do you want to continue?';
$string['launchtask_course_notfound'] = 'The selected course was not found.';
